...
class ListValut extends Component {
    ...
    //                     data-value={item.kodval}
    //                     data={item.price}
    //                     onClick={active !== item.kodval ? this.handleFilterChage : this.zaglushka}
    //                     name={item.id}
    //                     ref={item.kodval}
    //                     onFocus={this.handleFocus}
    //                 />
    ...
    displayBanksSecondScreen = (bank) => {
        console.log(bank);
        return (this.viborkaBanks(bank).map((banki) => {
            return (<li key={banki}>
                {banki}
                <ul>
                    {bank.map((item) => {
    ...
    secondScreen = () => {
        ...
        switch (this.props.filter) {
            case 'byn': switch (this.props.activePareBanks) {
                case 'usd_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[3], this.props.state.kursibanki[3]))
                case 'eur_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[5], this.props.state.kursibanki[5]))
                case 'gbp_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[7], this.props.state.kursibanki[7]))
                case 'chf_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[9], this.props.state.kursibanki[9]))
                case 'rub_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[11], this.props.state.kursibanki[11]))
                case 'uah_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[13], this.props.state.kursibanki[13]))
                case 'pln_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[15], this.props.state.kursibanki[15]))
                case 'czk_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[17], this.props.state.kursibanki[17]))
                case 'kzt_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[19], this.props.state.kursibanki[19]))
                case 'cny_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[0], this.props.state.kursibanki[21], this.props.state.kursibanki[21]))

                case 'usd_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[2], this.props.state.kursibanki[2]))
                case 'eur_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[4], this.props.state.kursibanki[4]))
                case 'gbp_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[6], this.props.state.kursibanki[6]))
                case 'chf_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[8], this.props.state.kursibanki[8]))
                case 'rub_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[10], this.props.state.kursibanki[10]))
                case 'uah_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[12], this.props.state.kursibanki[12]))
                case 'pln_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[14], this.props.state.kursibanki[14]))
                case 'czk_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[16], this.props.state.kursibanki[16]))
                case 'kzt_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[18], this.props.state.kursibanki[18]))
                case 'cny_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[1], this.props.state.kursibanki[20], this.props.state.kursibanki[20]))
                default:
            }
                break;

            case 'usd': switch (this.props.activePareBanks) {
                case 'usd_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[2], this.props.state.kursibanki[0], this.props.state.kursibanki[3]))
                case 'eur_usd_sell': return (this.vivodTooStr(this.props.state.kursibanki[2], this.props.state.kursibanki[4], this.props.state.kursibanki[23]))
                case 'usd_rub_sell': return (this.vivodTooStr(this.props.state.kursibanki[2], this.props.state.kursibanki[10], this.props.state.kursibanki[27]))

                case 'usd_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[3], this.props.state.kursibanki[1], this.props.state.kursibanki[2]))
                case 'eur_usd_buy': return (this.vivodTooStr(this.props.state.kursibanki[3], this.props.state.kursibanki[5], this.props.state.kursibanki[22]))
                case 'usd_rub_buy': return (this.vivodTooStr(this.props.state.kursibanki[3], this.props.state.kursibanki[11], this.props.state.kursibanki[26]))
                default:
            }
                break;

            case 'eur': switch (this.props.activePareBanks) {
                case 'eur_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[4], this.props.state.kursibanki[0], this.props.state.kursibanki[5]))
                case 'eur_usd_sell': return (this.vivodTooStr(this.props.state.kursibanki[4], this.props.state.kursibanki[2], this.props.state.kursibanki[23]))
                case 'eur_rub_sell': return (this.vivodTooStr(this.props.state.kursibanki[4], this.props.state.kursibanki[10], this.props.state.kursibanki[25]))

                case 'eur_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[5], this.props.state.kursibanki[1], this.props.state.kursibanki[4]))
                case 'eur_usd_buy': return (this.vivodTooStr(this.props.state.kursibanki[5], this.props.state.kursibanki[3], this.props.state.kursibanki[22]))
                case 'eur_rub_buy': return (this.vivodTooStr(this.props.state.kursibanki[5], this.props.state.kursibanki[11], this.props.state.kursibanki[24]))
                default:
            }
                break;

            case 'gbp': switch (this.props.activePareBanks) {
                case 'gbp_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[6], this.props.state.kursibanki[0], this.props.state.kursibanki[7]))

                case 'gbp_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[7], this.props.state.kursibanki[1], this.props.state.kursibanki[6]))
                default:
            }
                break;

            case 'chf': switch (this.props.activePareBanks) {
                case 'chf_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[8], this.props.state.kursibanki[0], this.props.state.kursibanki[9]))

                case 'chf_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[9], this.props.state.kursibanki[1], this.props.state.kursibanki[8]))
                default:
            }
                break;

            case 'rub': switch (this.props.activePareBanks) {
                case 'rub_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[10], this.props.state.kursibanki[0], this.props.state.kursibanki[11]))
                case 'usd_rub_sell': return (this.vivodTooStr(this.props.state.kursibanki[10], this.props.state.kursibanki[2], this.props.state.kursibanki[27]))
                case 'eur_rub_sell': return (this.vivodTooStr(this.props.state.kursibanki[10], this.props.state.kursibanki[4], this.props.state.kursibanki[25]))

                case 'rub_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[11], this.props.state.kursibanki[1], this.props.state.kursibanki[10]))
                case 'usd_rub_buy': return (this.vivodTooStr(this.props.state.kursibanki[11], this.props.state.kursibanki[3], this.props.state.kursibanki[26]))
                case 'eur_rub_buy': return (this.vivodTooStr(this.props.state.kursibanki[11], this.props.state.kursibanki[5], this.props.state.kursibanki[24]))
                default:
            }
                break;

            case 'uah': switch (this.props.activePareBanks) {
                case 'uah_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[12], this.props.state.kursibanki[0], this.props.state.kursibanki[13]))

                case 'uah_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[13], this.props.state.kursibanki[1], this.props.state.kursibanki[12]))
                default:
            }
                break;

            case 'pln': switch (this.props.activePareBanks) {
                case 'pln_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[14], this.props.state.kursibanki[0], this.props.state.kursibanki[15]))

                case 'pln_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[15], this.props.state.kursibanki[1], this.props.state.kursibanki[14]))
                default:
            }
                break;

            case 'czk': switch (this.props.activePareBanks) {
                case 'czk_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[16], this.props.state.kursibanki[0], this.props.state.kursibanki[16]))

                case 'czk_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[17], this.props.state.kursibanki[1], this.props.state.kursibanki[17]))
                default:
            }
                break;

            case 'kzt': switch (this.props.activePareBanks) {
                case 'kzt_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[18], this.props.state.kursibanki[0], this.props.state.kursibanki[19]))

                case 'kzt_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[19], this.props.state.kursibanki[1], this.props.state.kursibanki[18]))
                default:
            }
                break;

            case 'cny': switch (this.props.activePareBanks) {
                case 'cny_byn_sell': return (this.vivodTooStr(this.props.state.kursibanki[20], this.props.state.kursibanki[0], this.props.state.kursibanki[21]))

                case 'cny_byn_buy': return (this.vivodTooStr(this.props.state.kursibanki[21], this.props.state.kursibanki[1], this.props.state.kursibanki[20]))
                default:
            }
                break;
